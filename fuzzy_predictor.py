...
def create_failure_predictor(params):
    """
    Builds a robust fuzzy logic predictor using a list of 12 optimized parameters.
    """
    ...
    # Build overlapping membership functions from the evolved parameters
    ...
    vib['medium'] = fuzz.trimf(vib.universe, [v_low_mid, v_med_mid, v_high_start]) # Overlaps with low and high to avoid dead end
    vib['high'] = fuzz.trimf(vib.universe, [v_med_end, v_high_mid, 30]) # Starts from the end of medium's core
